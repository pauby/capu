...
$update_all_url  = if ($Github_UserRepo) {"https://github.com/$Github_UserRepo/blob/master/update_all.ps1" } else { "https://github.com/pauby/capu-packages-template/blob/master/update_all.ps1" }

$icon_ok = 'https://cdn.rawgit.com/pauby/capu/master/AU/Plugins/Report/r_ok.png'
$icon_er = 'https://cdn.rawgit.com/pauby/capu/master/AU/Plugins/Report/r_er.png'
...
_This file is automatically generated by the [update_all.ps1]($update_all_url) script using the [AU module](https://github.com/pauby/capu)._
"@
